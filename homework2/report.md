...
|----------|----------|-----------------|-----------|-----------|
| 測試一 | 題目一<br>（Add） | `p = 3 3 2 2 1 -4 0`<br>`q = 2 1 1 1 0`<br>`p.Add(q)` | `3x^2 + 3x - 3` | `3*x^2 + 3*x - 3` |
| 測試二 | 題目一<br>（Mult） | `p = 3 3 2 2 1 -4 0`<br>`q = 2 1 1 1 0`<br>`p.Mult(q)` | `3x^3 + 5x^2 - 2x - 4` | `3*x^3 + 5*x^2 - 2*x - 4` |
| 測試三 | 題目一<br>（Eval） | `p = 3 3 2 2 1 -4 0`<br>`x = 2`<br>`p.Eval(2)` | `12` | `12` |
| 測試四 | 題目二<br>（operator>> 之後 operator<<） | `3 3 2 2 1 -4 0` | `3x^2 + 2x - 4` | `3*x^2 + 2*x - 4` |

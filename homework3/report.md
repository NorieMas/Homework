...
| 測試二   | 題目一   | A: 2 1 2 -1 1<br>B: 2 -1 2 1 1<br>x=3     | A=1x^2-1x^1<br>B=-1x^2+1x^1<br>A+B=0<br>A-B=2x^2-2x^1<br>A\*B=-1x^4+2x^3-1x^2<br>A(3)=6 | 同預期                                                   |
| 測試三   | 題目一   | A: 1 0 0<br>B: 1 0 0<br>x=5               | A=1x^0<br>B=1x^0<br>A+B=2x^0<br>A-B=0<br>A\*B=1x^0<br>A(5)=1 | 同預期                                                   |
| 測試四   | 題目一   | A: 0<br>B: 0<br>x=1                       | A=0<br>B=0<br>A+B=0<br>A-B=0<br>A\*B=0<br>A(1)=0           | 同預期                                                   |
| 測試五   | 題目一   | A: 2 3 5 2 3<br>B: 2 4 5 -2 3<br>x=1      | A=3x^5+2x^3<br>B=4x^5-2x^3<br>A+B=7x^5<br>A-B=-1x^3-1x^3+1x^3=1x^3<br>A\*B=12x^10+6x^8-6x^8-4x^6=12x^10+2x^6<br>A(1)=5 | 同預期                                                   |
